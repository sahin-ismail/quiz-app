...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            QuizDbHelper dpHelper = new QuizDbHelper(this);
            questionList = dpHelper.getAllQuestions();
            getQuestionCountTotal = questionList.size();
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < getQuestionCountTotal) {
            ...
            questionCounter++;
            textViewQuestionCount.setText("Question: " + questionCounter + "/" + getQuestionCountTotal);
            answered = false;
